...
/* "samplers/randomkit_wrapper.pxd":25
...
struct __pyx_obj_8samplers_17randomkit_wrapper_RandomKit {
  PyObject_HEAD
  struct __pyx_vtabstruct_8samplers_17randomkit_wrapper_RandomKit *__pyx_vtab;
  rk_state *state;
};
...
struct __pyx_obj_7bmtools_4mcmc_21swendsen_wang_sampler_SwendsenWangSampler {
  ...
  int n_unit;
  struct __pyx_obj_8samplers_17randomkit_wrapper_RandomKit *rng;
};
...
struct __pyx_vtabstruct_8samplers_17randomkit_wrapper_RandomKit {
  unsigned long (*integer)(struct __pyx_obj_8samplers_17randomkit_wrapper_RandomKit *, unsigned long);
  double (*uniform)(struct __pyx_obj_8samplers_17randomkit_wrapper_RandomKit *);
  double (*gaussian)(struct __pyx_obj_8samplers_17randomkit_wrapper_RandomKit *);
};
static struct __pyx_vtabstruct_8samplers_17randomkit_wrapper_RandomKit *__pyx_vtabptr_8samplers_17randomkit_wrapper_RandomKit;
 ...
 *         else:
 */
    __pyx_t_10 = __pyx_v_self->n_unit;
 ...
 */
  __pyx_t_13 = __pyx_v_self->units_state;
 ...
 */
    __pyx_t_13 = __pyx_v_self->units_state;
    __PYX_INC_MEMVIEW(&__pyx_t_13, 1);
    __pyx_t_15.data = __pyx_v_samples.data;
    __pyx_t_15.memview = __pyx_v_samples.memview;
...
__pyx_t_15.shape[0] = __pyx_v_samples.shape[1];
...
static PyObject *__pyx_tp_new_7bmtools_4mcmc_21swendsen_wang_sampler_SwendsenWangSampler(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  ...
  p->rng = ((struct __pyx_obj_8samplers_17randomkit_wrapper_RandomKit *)Py_None); Py_INCREF(Py_None);
