...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "bmtools.exact.likelihood"
}
END: Cython Metadata */
...
#define __PYX_HAVE__bmtools__exact__likelihood
#define __PYX_HAVE_API__bmtools__exact__likelihood
#include "math.h"
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'bmtools.exact.likelihood' */
...
static void __pyx_f_7bmtools_5exact_10likelihood_accum_data_dependent_log_lik_terms(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int); /*proto*/
static double __pyx_f_7bmtools_5exact_10likelihood_calc_b_h_given_v(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "bmtools.exact.likelihood"
int __pyx_module_is_main_bmtools__exact__likelihood = 0;

/* Implementation of 'bmtools.exact.likelihood' */
...
static const char __pyx_k_bmtools_exact_likelihood[] = "bmtools.exact.likelihood";
...
static PyObject *__pyx_n_s_bmtools_exact_likelihood;
...
static PyObject *__pyx_pf_7bmtools_5exact_10likelihood_log_likelihood(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_weights, __Pyx_memviewslice __pyx_v_biases, int __pyx_v_num_threads); /* proto */
...
/* "bmtools/exact/likelihood.pyx":23
...
static PyObject *__pyx_pw_7bmtools_5exact_10likelihood_1log_likelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_weights,&__pyx_n_s_biases,&__pyx_n_s_num_threads,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_weights)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("log_likelihood", 0, 3, 4, 1); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_biases)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("log_likelihood", 0, 3, 4, 2); __PYX_ERR(0, 23, __pyx_L3_error)
        }
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "log_likelihood") < 0)) __PYX_ERR(0, 23, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_7bmtools_5exact_7helpers_state_t(values[0]); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_weights = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_weights.memview)) __PYX_ERR(0, 23, __pyx_L3_error)
    __pyx_v_biases = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2]); if (unlikely(!__pyx_v_biases.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_num_threads = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_num_threads == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("log_likelihood", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 23, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("bmtools.exact.likelihood.log_likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7bmtools_5exact_10likelihood_log_likelihood(__pyx_self, __pyx_v_data, __pyx_v_weights, __pyx_v_biases, __pyx_v_num_threads);
...
static PyObject *__pyx_pf_7bmtools_5exact_10likelihood_log_likelihood(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_weights, __Pyx_memviewslice __pyx_v_biases, int __pyx_v_num_threads) {
  int __pyx_v_t;
  int __pyx_v_n_unit;
  int __pyx_v_n_state;
  int __pyx_v_n_data;
  ...
  /* "bmtools/exact/likelihood.pyx":63
 *         likelihood for the corresponding entry in the data array.
 *     """
 *     if num_threads <= 0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "bmtools/exact/likelihood.pyx":64
 *     """
 *     if num_threads <= 0:
 *         raise ValueError('Number of threads must be > 0')             # <<<<<<<<<<<<<<
 *     cdef int t
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":66
 *         raise ValueError('Number of threads must be > 0')
 *     cdef int t
 *     cdef int n_unit = weights.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":67
 *     cdef int t
 *     cdef int n_unit = weights.shape[0]
 *     cdef int n_state = 2**n_unit             # <<<<<<<<<<<<<<
 *     cdef int n_data = data.shape[0]
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":68
 *     cdef int n_unit = weights.shape[0]
 *     cdef int n_state = 2**n_unit
 *     cdef int n_data = data.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int n_visible = data.shape[1]
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":69
 *     cdef int n_state = 2**n_unit
 *     cdef int n_data = data.shape[0]
 *     cdef int n_visible = data.shape[1]             # <<<<<<<<<<<<<<
 *     cdef int n_hidden = n_unit - n_visible
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":70
 *     cdef int n_data = data.shape[0]
 *     cdef int n_visible = data.shape[1]
 *     cdef int n_hidden = n_unit - n_visible             # <<<<<<<<<<<<<<
 *     cdef state_t[:, :] states = array(
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":72
 *     cdef int n_hidden = n_unit - n_visible
 *     cdef state_t[:, :] states = array(
 *             shape=(num_threads, n_unit), itemsize=sizeof(state_t),             # <<<<<<<<<<<<<<
 *             format=state_t_code)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_num_threads); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 72, __pyx_L1_error)
  ...
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_shape, __pyx_t_5) < 0) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_FromSize_t((sizeof(__pyx_t_7bmtools_5exact_7helpers_state_t))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_itemsize, __pyx_t_5) < 0) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "bmtools/exact/likelihood.pyx":73
 *     cdef state_t[:, :] states = array(
 *             shape=(num_threads, n_unit), itemsize=sizeof(state_t),
 *             format=state_t_code)             # <<<<<<<<<<<<<<
 *     cdef double[:] log_lik = array(
 ...
 */
  __pyx_t_5 = __Pyx_PyBytes_FromString(__pyx_v_7bmtools_5exact_7helpers_state_t_code); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_format, __pyx_t_5) < 0) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "bmtools/exact/likelihood.pyx":71
 *     cdef int n_visible = data.shape[1]
 *     cdef int n_hidden = n_unit - n_visible
 *     cdef state_t[:, :] states = array(             # <<<<<<<<<<<<<<
 *             shape=(num_threads, n_unit), itemsize=sizeof(state_t),
 *             format=state_t_code)
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_7bmtools_5exact_7helpers_state_t(__pyx_t_5);
  if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_states = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "bmtools/exact/likelihood.pyx":75
 *             format=state_t_code)
 *     cdef double[:] log_lik = array(
 *             shape=(n_data,), itemsize=sizeof(double), format='d')             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_n_data); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_shape, __pyx_t_4) < 0) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_itemsize, __pyx_t_4) < 0) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_format, __pyx_n_s_d) < 0) __PYX_ERR(0, 75, __pyx_L1_error)

  /* "bmtools/exact/likelihood.pyx":74
 *             shape=(num_threads, n_unit), itemsize=sizeof(state_t),
 *             format=state_t_code)
 *     cdef double[:] log_lik = array(             # <<<<<<<<<<<<<<
 *             shape=(n_data,), itemsize=sizeof(double), format='d')
 *     cdef double[:] norm_consts = array(
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_4);
  if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_log_lik = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "bmtools/exact/likelihood.pyx":77
 *             shape=(n_data,), itemsize=sizeof(double), format='d')
 *     cdef double[:] norm_consts = array(
 *             shape=(num_threads,), itemsize=sizeof(double), format='d')             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_num_threads); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_shape, __pyx_t_2) < 0) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_itemsize, __pyx_t_2) < 0) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_format, __pyx_n_s_d) < 0) __PYX_ERR(0, 77, __pyx_L1_error)

  /* "bmtools/exact/likelihood.pyx":76
 *     cdef double[:] log_lik = array(
 *             shape=(n_data,), itemsize=sizeof(double), format='d')
 *     cdef double[:] norm_consts = array(             # <<<<<<<<<<<<<<
 *             shape=(num_threads,), itemsize=sizeof(double), format='d')
 *     cdef double[:, :] b_h_given_v = array(
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "bmtools/exact/likelihood.pyx":79
 *             shape=(num_threads,), itemsize=sizeof(double), format='d')
 *     cdef double[:, :] b_h_given_v = array(
 *             shape=(num_threads, n_hidden), itemsize=sizeof(double), format='d')             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_num_threads); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_n_hidden); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __pyx_t_4 = 0;
  __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_shape, __pyx_t_3) < 0) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_itemsize, __pyx_t_3) < 0) __PYX_ERR(0, 79, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_format, __pyx_n_s_d) < 0) __PYX_ERR(0, 79, __pyx_L1_error)

  /* "bmtools/exact/likelihood.pyx":78
 *     cdef double[:] norm_consts = array(
 *             shape=(num_threads,), itemsize=sizeof(double), format='d')
 *     cdef double[:, :] b_h_given_v = array(             # <<<<<<<<<<<<<<
 *             shape=(num_threads, n_hidden), itemsize=sizeof(double), format='d')
 *     cdef int[:, :] intervals = array(
 */
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_3);
  if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_b_h_given_v = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "bmtools/exact/likelihood.pyx":81
 *             shape=(num_threads, n_hidden), itemsize=sizeof(double), format='d')
 *     cdef int[:, :] intervals = array(
 *             shape=(2, num_threads+1), itemsize=sizeof(int), format='i')             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_num_threads + 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_shape, __pyx_t_5) < 0) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_FromSize_t((sizeof(int))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_itemsize, __pyx_t_5) < 0) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_format, __pyx_n_s_i) < 0) __PYX_ERR(0, 81, __pyx_L1_error)

  /* "bmtools/exact/likelihood.pyx":80
 *     cdef double[:, :] b_h_given_v = array(
 *             shape=(num_threads, n_hidden), itemsize=sizeof(double), format='d')
 *     cdef int[:, :] intervals = array(             # <<<<<<<<<<<<<<
 *             shape=(2, num_threads+1), itemsize=sizeof(int), format='i')
 *     # partition state space and data points between threads
 */
  __pyx_t_5 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(__pyx_t_5);
  if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_intervals = __pyx_t_9;
  __pyx_t_9.memview = NULL;
  __pyx_t_9.data = NULL;

  /* "bmtools/exact/likelihood.pyx":83
 *             shape=(2, num_threads+1), itemsize=sizeof(int), format='i')
 *     # partition state space and data points between threads
 *     for t in range(num_threads):             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_10 = __pyx_v_num_threads;
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    __pyx_v_t = __pyx_t_11;

    /* "bmtools/exact/likelihood.pyx":84
 *     # partition state space and data points between threads
 *     for t in range(num_threads):
 *         intervals[0, t] = <int>(t * <float>(n_state) / num_threads)             # <<<<<<<<<<<<<<
 *         intervals[1, t] = <int>(t * <float>(n_data) / num_threads)
 ...
 */
    ...
    *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_12 * __pyx_v_intervals.strides[0]) ) + __pyx_t_13 * __pyx_v_intervals.strides[1]) )) = ((int)((__pyx_v_t * ((float)__pyx_v_n_state)) / __pyx_v_num_threads));

    /* "bmtools/exact/likelihood.pyx":85
 *     for t in range(num_threads):
 *         intervals[0, t] = <int>(t * <float>(n_state) / num_threads)
 *         intervals[1, t] = <int>(t * <float>(n_data) / num_threads)             # <<<<<<<<<<<<<<
 *     intervals[0, num_threads] = n_state
 ...
 */
    ...
    *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_14 * __pyx_v_intervals.strides[0]) ) + __pyx_t_15 * __pyx_v_intervals.strides[1]) )) = ((int)((__pyx_v_t * ((float)__pyx_v_n_data)) / __pyx_v_num_threads));
  }

  /* "bmtools/exact/likelihood.pyx":86
 *         intervals[0, t] = <int>(t * <float>(n_state) / num_threads)
 *         intervals[1, t] = <int>(t * <float>(n_data) / num_threads)
 *     intervals[0, num_threads] = n_state             # <<<<<<<<<<<<<<
 *     intervals[1, num_threads] = n_data
 ...
 */
  __pyx_t_16 = 0;
  __pyx_t_17 = __pyx_v_num_threads;
  *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_16 * __pyx_v_intervals.strides[0]) ) + __pyx_t_17 * __pyx_v_intervals.strides[1]) )) = __pyx_v_n_state;
  ...
  /* "bmtools/exact/likelihood.pyx":87
 *         intervals[1, t] = <int>(t * <float>(n_data) / num_threads)
 *     intervals[0, num_threads] = n_state
 *     intervals[1, num_threads] = n_data             # <<<<<<<<<<<<<<
 *     # get partitioned views of parameters for easier referencing
 ...
 */
  __pyx_t_18 = 1;
  __pyx_t_19 = __pyx_v_num_threads;
  *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_18 * __pyx_v_intervals.strides[0]) ) + __pyx_t_19 * __pyx_v_intervals.strides[1]) )) = __pyx_v_n_data;
  ...
  /* "bmtools/exact/likelihood.pyx":89
 *     intervals[1, num_threads] = n_data
 *     # get partitioned views of parameters for easier referencing
 *     cdef double[:, :] W_hh = weights[:n_hidden, :n_hidden]             # <<<<<<<<<<<<<<
...
__pyx_v_W_hh = __pyx_t_8;
  ...
  /* "bmtools/exact/likelihood.pyx":90
 *     # get partitioned views of parameters for easier referencing
 *     cdef double[:, :] W_hh = weights[:n_hidden, :n_hidden]
 *     cdef double[:, :] W_hv = weights[:n_hidden, n_hidden:]             # <<<<<<<<<<<<<<
 *     cdef double[:, :] W_vv = weights[n_hidden:, n_hidden:]
...
__pyx_v_W_hv = __pyx_t_8;
  ...
  /* "bmtools/exact/likelihood.pyx":91
 *     cdef double[:, :] W_hh = weights[:n_hidden, :n_hidden]
 *     cdef double[:, :] W_hv = weights[:n_hidden, n_hidden:]
 *     cdef double[:, :] W_vv = weights[n_hidden:, n_hidden:]             # <<<<<<<<<<<<<<
 *     cdef double[:] b_h = biases[:n_hidden]
...
__pyx_v_W_vv = __pyx_t_8;
  ...
  /* "bmtools/exact/likelihood.pyx":92
 *     cdef double[:, :] W_hv = weights[:n_hidden, n_hidden:]
 *     cdef double[:, :] W_vv = weights[n_hidden:, n_hidden:]
 *     cdef double[:] b_h = biases[:n_hidden]             # <<<<<<<<<<<<<<
 *     cdef double[:] b_v = biases[n_hidden:]
...
__pyx_v_b_h = __pyx_t_7;
  ...
  /* "bmtools/exact/likelihood.pyx":93
 *     cdef double[:, :] W_vv = weights[n_hidden:, n_hidden:]
 *     cdef double[:] b_h = biases[:n_hidden]
 *     cdef double[:] b_v = biases[n_hidden:]             # <<<<<<<<<<<<<<
 *     # set parallel threads calculating overall components of overall
...
__pyx_v_b_v = __pyx_t_7;
  ...
  /* "bmtools/exact/likelihood.pyx":96
 *     # set parallel threads calculating overall components of overall
 *     # normalisation constant and data dependent log likelihood terms
                ...
                #endif /* _OPENMP */
                {
                    ...
                    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_20; __pyx_t_11++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            /* "bmtools/exact/likelihood.pyx":99
 *                     num_threads=num_threads):
 *         norm_consts[t] = calc_norm_const(
 ...
 */
    ...
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
        ...
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 0)");
            ...
            PyGILState_Release(__pyx_gilstate_save);
            #endif
        __PYX_ERR(0, 99, __pyx_L11_error)
    }
...
__pyx_t_23 = 0;
                            ...
                            /* "bmtools/exact/likelihood.pyx":98
 *     for t in prange(num_threads, nogil=True, schedule='static', chunksize=1,
 *                     num_threads=num_threads):
 *         norm_consts[t] = calc_norm_const(             # <<<<<<<<<<<<<<
 *             weights, biases, states[t], intervals[0, t], intervals[0, t+1])
 ...
 */
                            ...
                            *((double *) ( /* dim=0 */ (__pyx_v_norm_consts.data + __pyx_t_29 * __pyx_v_norm_consts.strides[0]) )) = __pyx_t_27;
                            ...
                            /* "bmtools/exact/likelihood.pyx":101
 *             weights, biases, states[t], intervals[0, t], intervals[0, t+1])
 *         accum_data_dependent_log_lik_terms(
 *             W_hh, W_hv, W_vv, b_h, b_v, b_h_given_v[t], data,             # <<<<<<<<<<<<<<
...
__pyx_t_22.data = __pyx_v_states.data;
                            ...
                            /* "bmtools/exact/likelihood.pyx":102
 *         accum_data_dependent_log_lik_terms(
 *             W_hh, W_hv, W_vv, b_h, b_v, b_h_given_v[t], data,
 *             states[t, :n_hidden], log_lik, intervals[1, t],             # <<<<<<<<<<<<<<
 *             intervals[1, t+1])
...
__pyx_t_31 = 1;
                            ...
                            /* "bmtools/exact/likelihood.pyx":103
 *             W_hh, W_hv, W_vv, b_h, b_v, b_h_given_v[t], data,
 *             states[t, :n_hidden], log_lik, intervals[1, t],
 *             intervals[1, t+1])             # <<<<<<<<<<<<<<
 *     # accumulate overall normalisation constant terms calculated by
 ...
 */
                            ...
                            /* "bmtools/exact/likelihood.pyx":100
 *         norm_consts[t] = calc_norm_const(
 *             weights, biases, states[t], intervals[0, t], intervals[0, t+1])
 *         accum_data_dependent_log_lik_terms(             # <<<<<<<<<<<<<<
 *             W_hh, W_hv, W_vv, b_h, b_v, b_h_given_v[t], data,
 *             states[t, :n_hidden], log_lik, intervals[1, t],
 */
                            __pyx_f_7bmtools_5exact_10likelihood_accum_data_dependent_log_lik_terms(__pyx_v_W_hh, __pyx_v_W_hv, __pyx_v_W_vv, __pyx_v_b_h, __pyx_v_b_v, __pyx_t_7, __pyx_v_data, __pyx_t_22, __pyx_v_log_lik, (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_31 * __pyx_v_intervals.strides[0]) ) + __pyx_t_32 * __pyx_v_intervals.strides[1]) ))), (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_33 * __pyx_v_intervals.strides[0]) ) + __pyx_t_34 * __pyx_v_intervals.strides[1]) ))));
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":106
 *     # accumulate overall normalisation constant terms calculated by
 *     # different threads and take log
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":107
 *     # different threads and take log
 *     cdef double log_norm_const = 0.
 *     for t in range(num_threads):             # <<<<<<<<<<<<<<
 *         log_norm_const += norm_consts[t]
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_20; __pyx_t_11+=1) {
    ...
    /* "bmtools/exact/likelihood.pyx":108
 *     cdef double log_norm_const = 0.
 *     for t in range(num_threads):
 *         log_norm_const += norm_consts[t]             # <<<<<<<<<<<<<<
 *     log_norm_const = log(log_norm_const)
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":109
 *     for t in range(num_threads):
 *         log_norm_const += norm_consts[t]
 *     log_norm_const = log(log_norm_const)             # <<<<<<<<<<<<<<
 *     # adjust log-likelihood terms to account for overall normalisation
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":112
 *     # adjust log-likelihood terms to account for overall normalisation
 *     # constant
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_20; __pyx_t_11+=1) {
    ...
    /* "bmtools/exact/likelihood.pyx":113
 *     # constant
 *     for i in range(n_data):
 *         log_lik[i] -= log_norm_const             # <<<<<<<<<<<<<<
 *     return log_lik
 ...
 */
  ...
  /* "bmtools/exact/likelihood.pyx":114
 *     for i in range(n_data):
 *         log_lik[i] -= log_norm_const
 *     return log_lik             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_log_lik, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
  goto __pyx_L0;
...
/* "bmtools/exact/likelihood.pyx":117
 * 
 * 
...
static void __pyx_f_7bmtools_5exact_10likelihood_accum_data_dependent_log_lik_terms(__Pyx_memviewslice __pyx_v_W_hh, __Pyx_memviewslice __pyx_v_W_hv, __Pyx_memviewslice __pyx_v_W_vv, __Pyx_memviewslice __pyx_v_b_h, __Pyx_memviewslice __pyx_v_b_v, __Pyx_memviewslice __pyx_v_b_h_given_v, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_state, __Pyx_memviewslice __pyx_v_log_lik, int __pyx_v_start_data_index, int __pyx_v_end_data_index) {
  ...
  /* "bmtools/exact/likelihood.pyx":127
 *     """
 *     cdef int i
 ...
 */
  ...
  for (__pyx_t_2 = __pyx_v_start_data_index; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "bmtools/exact/likelihood.pyx":128
 *     cdef int i
 *     for i in range(start_data_index, end_data_index):
 *         calc_b_h_given_v(W_hv, data[i], b_h, b_h_given_v)             # <<<<<<<<<<<<<<
 *         log_lik[i] = log(calc_norm_const(W_hh, b_h_given_v, state))
...
__pyx_f_7bmtools_5exact_10likelihood_calc_b_h_given_v(__pyx_v_W_hv, __pyx_t_3, __pyx_v_b_h, __pyx_v_b_h_given_v);
    __PYX_XDEC_MEMVIEW(&__pyx_t_3, 0);
    __pyx_t_3.memview = NULL;
    __pyx_t_3.data = NULL;

    /* "bmtools/exact/likelihood.pyx":129
 *     for i in range(start_data_index, end_data_index):
 *         calc_b_h_given_v(W_hv, data[i], b_h, b_h_given_v)
 *         log_lik[i] = log(calc_norm_const(W_hh, b_h_given_v, state))             # <<<<<<<<<<<<<<
 *         log_lik[i] += neg_energy(data[i], W_vv, b_v)
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_log_lik.data + __pyx_t_4 * __pyx_v_log_lik.strides[0]) )) = log(__pyx_f_7bmtools_5exact_7moments_calc_norm_const(__pyx_v_W_hh, __pyx_v_b_h_given_v, __pyx_v_state, NULL));
    ...
    /* "bmtools/exact/likelihood.pyx":130
 *         calc_b_h_given_v(W_hv, data[i], b_h, b_h_given_v)
 *         log_lik[i] = log(calc_norm_const(W_hh, b_h_given_v, state))
 *         log_lik[i] += neg_energy(data[i], W_vv, b_v)             # <<<<<<<<<<<<<<
 * 
...
__pyx_t_5 = __pyx_v_i;
    *((double *) ( /* dim=0 */ (__pyx_v_log_lik.data + __pyx_t_5 * __pyx_v_log_lik.strides[0]) )) += __pyx_f_7bmtools_5exact_7helpers_neg_energy(__pyx_t_3, __pyx_v_W_vv, __pyx_v_b_v);
    __PYX_XDEC_MEMVIEW(&__pyx_t_3, 0);
    __pyx_t_3.memview = NULL;
    __pyx_t_3.data = NULL;
  }
 ...
 */
  ...
  __pyx_L1_error:;
  __PYX_XDEC_MEMVIEW(&__pyx_t_3, 0);
  __Pyx_WriteUnraisable("bmtools.exact.likelihood.accum_data_dependent_log_lik_terms", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 1);
  __pyx_L0:;
}

/* "bmtools/exact/likelihood.pyx":133
 * 
 * 
...
static double __pyx_f_7bmtools_5exact_10likelihood_calc_b_h_given_v(__Pyx_memviewslice __pyx_v_W_hv, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_b_h, __Pyx_memviewslice __pyx_v_b_h_given_v) {
  int __pyx_v_i;
  int __pyx_v_j;
  double __pyx_r;
  ...
  /* "bmtools/exact/likelihood.pyx":142
 *     """
 *     cdef int i, j
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "bmtools/exact/likelihood.pyx":143
 *     cdef int i, j
 *     for i in range(W_hv.shape[0]):
 *         b_h_given_v[i] = b_h[i]             # <<<<<<<<<<<<<<
 *         for j in range(W_hv.shape[1]):
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_b_h_given_v.data + __pyx_t_4 * __pyx_v_b_h_given_v.strides[0]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_b_h.data + __pyx_t_3 * __pyx_v_b_h.strides[0]) )));
    ...
    /* "bmtools/exact/likelihood.pyx":144
 *     for i in range(W_hv.shape[0]):
 *         b_h_given_v[i] = b_h[i]
 *         for j in range(W_hv.shape[1]):             # <<<<<<<<<<<<<<
 *             b_h_given_v[i] += W_hv[i, j] * v[j]
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "bmtools/exact/likelihood.pyx":145
 *         b_h_given_v[i] = b_h[i]
 *         for j in range(W_hv.shape[1]):
 *             b_h_given_v[i] += W_hv[i, j] * v[j]             # <<<<<<<<<<<<<<
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_b_h_given_v.data + __pyx_t_10 * __pyx_v_b_h_given_v.strides[0]) )) += ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_W_hv.data + __pyx_t_7 * __pyx_v_W_hv.strides[0]) ) + __pyx_t_8 * __pyx_v_W_hv.strides[1]) ))) * (*((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_9 * __pyx_v_v.strides[0]) ))));
    }
  }
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "bmtools.exact.likelihood.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.likelihood.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.likelihood.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.likelihood._memoryviewslice", /*tp_name*/
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "likelihood",
    __pyx_k_Boltzmann_machine_likelihood_Fun, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_bmtools_exact_likelihood, __pyx_k_bmtools_exact_likelihood, sizeof(__pyx_k_bmtools_exact_likelihood), 0, 0, 1, 1},
 ...
 *     cdef int n_unit = weights.shape[0]
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Number_of_threads_must_be_0); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 64, __pyx_L1_error)
 ...
 *     """
 */
  __pyx_tuple__15 = PyTuple_Pack(22, __pyx_n_s_data, __pyx_n_s_weights, __pyx_n_s_biases, __pyx_n_s_num_threads, __pyx_n_s_t, __pyx_n_s_n_unit, __pyx_n_s_n_state, __pyx_n_s_n_data, __pyx_n_s_n_visible, __pyx_n_s_n_hidden, __pyx_n_s_states, __pyx_n_s_log_lik, __pyx_n_s_norm_consts, __pyx_n_s_b_h_given_v, __pyx_n_s_intervals, __pyx_n_s_W_hh, __pyx_n_s_W_hv, __pyx_n_s_W_vv, __pyx_n_s_b_h, __pyx_n_s_b_v, __pyx_n_s_log_norm_const, __pyx_n_s_i); if (unlikely(!__pyx_tuple__15)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__15);
  __Pyx_GIVEREF(__pyx_tuple__15);
  __pyx_codeobj__16 = (PyObject*)__Pyx_PyCode_New(4, 0, 22, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__15, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_matt_Projects_boltzmann_ma, __pyx_n_s_log_likelihood, 23, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__16)) __PYX_ERR(0, 23, __pyx_L1_error)
 ...
 */
  __pyx_tuple__17 = PyTuple_Pack(1, __pyx_kp_s_strided_and_direct_or_indirect); if (unlikely(!__pyx_tuple__17)) __PYX_ERR(1, 282, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__18 = PyTuple_Pack(1, __pyx_kp_s_strided_and_direct); if (unlikely(!__pyx_tuple__18)) __PYX_ERR(1, 283, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__19 = PyTuple_Pack(1, __pyx_kp_s_strided_and_indirect); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(1, 284, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__20 = PyTuple_Pack(1, __pyx_kp_s_contiguous_and_direct); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(1, 287, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__21 = PyTuple_Pack(1, __pyx_kp_s_contiguous_and_indirect); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(1, 288, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initlikelihood(void); /*proto*/
PyMODINIT_FUNC initlikelihood(void)
#else
PyMODINIT_FUNC PyInit_likelihood(void); /*proto*/
PyMODINIT_FUNC PyInit_likelihood(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_likelihood(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("likelihood", __pyx_methods, __pyx_k_Boltzmann_machine_likelihood_Fun, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_bmtools__exact__likelihood) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bmtools.exact.likelihood")) {
      if (unlikely(PyDict_SetItemString(modules, "bmtools.exact.likelihood", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  __pyx_t_3 = __Pyx_ImportModule("bmtools.exact.moments"); if (!__pyx_t_3) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_3, "calc_norm_const", (void (**)(void))&__pyx_f_7bmtools_5exact_7moments_calc_norm_const, "double (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, struct __pyx_opt_args_7bmtools_5exact_7moments_calc_norm_const *__pyx_optional_args)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 *     """
 */
  __pyx_t_4 = PyCFunction_NewEx(&__pyx_mdef_7bmtools_5exact_10likelihood_1log_likelihood, NULL, __pyx_n_s_bmtools_exact_likelihood); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_log_likelihood, __pyx_t_4) < 0) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "bmtools/exact/likelihood.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 ...
 *     def __dealloc__(array self):
 */
  __pyx_t_4 = __pyx_capsule_create(((void *)(&__pyx_array_getbuffer)), ((char *)"getbuffer(obj, view, flags)")); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 207, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_array_type->tp_dict, __pyx_n_s_pyx_getbuffer, __pyx_t_4) < 0) __PYX_ERR(1, 207, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 * cdef indirect = Enum("<strided and indirect>")
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__17, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 282, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__18, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 283, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__19, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 284, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__20, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 287, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 288, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
 ...
 * 
 */
  __pyx_t_4 = __pyx_capsule_create(((void *)(&__pyx_memoryview_getbuffer)), ((char *)"getbuffer(obj, view, flags)")); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 535, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_memoryview_type->tp_dict, __pyx_n_s_pyx_getbuffer, __pyx_t_4) < 0) __PYX_ERR(1, 535, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 * 
 */
  __pyx_t_4 = __pyx_capsule_create(((void *)(&__pyx_memoryview_getbuffer)), ((char *)"getbuffer(obj, view, flags)")); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 981, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_memoryviewslice_type->tp_dict, __pyx_n_s_pyx_getbuffer, __pyx_t_4) < 0) __PYX_ERR(1, 981, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bmtools.exact.likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bmtools.exact.likelihood");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
