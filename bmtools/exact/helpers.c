...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "bmtools.exact.helpers"
}
END: Cython Metadata */
...
#define __PYX_HAVE__bmtools__exact__helpers
#define __PYX_HAVE_API__bmtools__exact__helpers
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
static char *__pyx_v_7bmtools_5exact_7helpers_state_t_code;
...
#define __Pyx_MODULE_NAME "bmtools.exact.helpers"
int __pyx_module_is_main_bmtools__exact__helpers = 0;

/* Implementation of 'bmtools.exact.helpers' */
...
static const char __pyx_k_Boltzmann_machine_helpers_Cython[] = "Boltzmann machine helpers.\n\nCython helper functions for working with Boltzmann machine distributions.\n";
...
static PyObject *__pyx_pf_7bmtools_5exact_7helpers_check_state_space_size(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_num_units, int __pyx_v_force); /* proto */
static PyObject *__pyx_pf_7bmtools_5exact_7helpers_2index_to_state(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_index, __Pyx_memviewslice __pyx_v_state); /* proto */
...
static double __pyx_f_7bmtools_5exact_7helpers_neg_energy(__Pyx_memviewslice __pyx_v_state, __Pyx_memviewslice __pyx_v_weights, __Pyx_memviewslice __pyx_v_biases) {
  double __pyx_v_neg_energy;
  int __pyx_v_i;
  int __pyx_v_j;
  double __pyx_r;
 ...
 */
  __pyx_v_neg_energy = 0.;

  /* "bmtools/exact/helpers.pyx":19
 *     cdef double neg_energy = 0.
 *     cdef int i, j
 *     for i in range(state.shape[0]):             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    __pyx_t_4 = __pyx_v_i;
    __pyx_v_neg_energy = (__pyx_v_neg_energy + ((*((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_3 * __pyx_v_state.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_biases.data + __pyx_t_4 * __pyx_v_biases.strides[0]) )))));

    /* "bmtools/exact/helpers.pyx":21
 *     for i in range(state.shape[0]):
 *         neg_energy += state[i] * biases[i]
 *         for j in range(i):             # <<<<<<<<<<<<<<
 *             neg_energy += state[i] * weights[i, j] * state[j]
 ...
 */
      ...
      __pyx_v_neg_energy = (__pyx_v_neg_energy + (((*((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_7 * __pyx_v_state.strides[0]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_weights.data + __pyx_t_8 * __pyx_v_weights.strides[0]) ) + __pyx_t_9 * __pyx_v_weights.strides[1]) )))) * (*((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_10 * __pyx_v_state.strides[0]) )))));
    }
  }

  /* "bmtools/exact/helpers.pyx":23
 *         for j in range(i):
 *             neg_energy += state[i] * weights[i, j] * state[j]
 *     return neg_energy             # <<<<<<<<<<<<<<
 * 
...
static __Pyx_memviewslice __pyx_f_7bmtools_5exact_7helpers_partition_state_space(long __pyx_v_num_states, int __pyx_v_num_threads) {
  int __pyx_v_t;
  ...
  Py_ssize_t __pyx_t_7;
  Py_ssize_t __pyx_t_8;
  __Pyx_RefNannySetupContext("partition_state_space", 0);

  /* "bmtools/exact/helpers.pyx":40
 *     cdef int t
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_num_threads + 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
  ...
  __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_shape, __pyx_t_3) < 0) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_FromSize_t((sizeof(long))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_itemsize, __pyx_t_3) < 0) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_format, __pyx_n_s_l) < 0) __PYX_ERR(0, 40, __pyx_L1_error)

  /* "bmtools/exact/helpers.pyx":39
 *     """
 *     cdef int t
 *     cdef long[:] intervals = array(             # <<<<<<<<<<<<<<
 *             shape=(num_threads + 1,), itemsize=sizeof(long), format='l')
 *     for t in range(num_threads):
 */
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_t_3);
 ...
 */
  __pyx_t_5 = __pyx_v_num_threads;
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_t = __pyx_t_6;

    /* "bmtools/exact/helpers.pyx":42
 *             shape=(num_threads + 1,), itemsize=sizeof(long), format='l')
 *     for t in range(num_threads):
 *         intervals[t] = <long>(t * <float>(num_states) / num_threads)             # <<<<<<<<<<<<<<
 *     intervals[num_threads] = num_states
 ...
 */
    __pyx_t_7 = __pyx_v_t;
    *((long *) ( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_7 * __pyx_v_intervals.strides[0]) )) = ((long)((__pyx_v_t * ((float)__pyx_v_num_states)) / __pyx_v_num_threads));
  }

  /* "bmtools/exact/helpers.pyx":43
 *     for t in range(num_threads):
 *         intervals[t] = <long>(t * <float>(num_states) / num_threads)
 *     intervals[num_threads] = num_states             # <<<<<<<<<<<<<<
 *     return intervals
 ...
 */
  ...
  *((long *) ( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_8 * __pyx_v_intervals.strides[0]) )) = __pyx_v_num_states;

  /* "bmtools/exact/helpers.pyx":44
 *         intervals[t] = <long>(t * <float>(num_states) / num_threads)
 *     intervals[num_threads] = num_states
 *     return intervals             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_intervals, 0);
 ...
 */
  ...
  __Pyx_AddTraceback("bmtools.exact.helpers.partition_state_space", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
static PyObject *__pyx_pw_7bmtools_5exact_7helpers_1check_state_space_size(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_7bmtools_5exact_7helpers_check_state_space_size(int __pyx_v_num_units, int __pyx_v_force, CYTHON_UNUSED int __pyx_skip_dispatch) {
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
  PyObject *__pyx_t_3 = NULL;
  ...
  __Pyx_RefNannySetupContext("check_state_space_size", 0);

  /* "bmtools/exact/helpers.pyx":49
 * cpdef void check_state_space_size(int num_units, bint force):
 *     """Raises ValueError if size of state space is large unless force set."""
 *     if num_units > 20 and not force:             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_2 = ((__pyx_v_num_units > 20) != 0);
  if (__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
 ...
 * 
 */
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_Size_of_state_space_0_very_large, __pyx_n_s_format); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyInt_From_long(__Pyx_pow_long(2, ((long)__pyx_v_num_units))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 52, __pyx_L1_error)
    ...
    if (!__pyx_t_6) {
      __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 52, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_WriteUnraisable("bmtools.exact.helpers.check_state_space_size", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
...
/* Python wrapper */
static PyObject *__pyx_pw_7bmtools_5exact_7helpers_1check_state_space_size(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7bmtools_5exact_7helpers_check_state_space_size[] = "check_state_space_size(int num_units, bool force) -> void\nRaises ValueError if size of state space is large unless force set.";
static PyObject *__pyx_pw_7bmtools_5exact_7helpers_1check_state_space_size(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_num_units;
  int __pyx_v_force;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("check_state_space_size (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_num_units,&__pyx_n_s_force,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_num_units)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_force)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("check_state_space_size", 1, 2, 2, 1); __PYX_ERR(0, 47, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "check_state_space_size") < 0)) __PYX_ERR(0, 47, __pyx_L3_error)
      }
    ...
    __pyx_v_num_units = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_num_units == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 47, __pyx_L3_error)
    __pyx_v_force = __Pyx_PyObject_IsTrue(values[1]); if (unlikely((__pyx_v_force == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 47, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("check_state_space_size", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 47, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("bmtools.exact.helpers.check_state_space_size", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7bmtools_5exact_7helpers_check_state_space_size(__pyx_self, __pyx_v_num_units, __pyx_v_force);
...
static PyObject *__pyx_pf_7bmtools_5exact_7helpers_check_state_space_size(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_num_units, int __pyx_v_force) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("check_state_space_size", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_7bmtools_5exact_7helpers_check_state_space_size(__pyx_v_num_units, __pyx_v_force, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static void __pyx_f_7bmtools_5exact_7helpers_next_state(__Pyx_memviewslice __pyx_v_state, long __pyx_v_next_state_index) {
 ...
 */
  __pyx_t_1 = 0;
  *((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_1 * __pyx_v_state.strides[0]) )) *= -1;

  /* "bmtools/exact/helpers.pyx":65
 *     cdef int unit_index = 1
 *     state[0] *= -1
 *     while next_state_index % 2 == 0 and unit_index < state.shape[0]:             # <<<<<<<<<<<<<<
 *         state[unit_index] *= -1
 ...
 */
    ...
    *((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_4 * __pyx_v_state.strides[0]) )) *= -1;

    /* "bmtools/exact/helpers.pyx":67
 *     while next_state_index % 2 == 0 and unit_index < state.shape[0]:
 *         state[unit_index] *= -1
 *         next_state_index /= 2             # <<<<<<<<<<<<<<
 *         unit_index += 1
...
static PyObject *__pyx_pw_7bmtools_5exact_7helpers_3index_to_state(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_7bmtools_5exact_7helpers_index_to_state(long __pyx_v_index, __Pyx_memviewslice __pyx_v_state, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  Py_ssize_t __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
 ...
 *         else:
 */
    __pyx_t_3 = (((__pyx_v_index & 1) == 1) != 0);
    if (__pyx_t_3) {

      /* "bmtools/exact/helpers.pyx":84
 *     for i in range(state.shape[0]):
 *         if index & 1 == 1:
 *             state[i] = 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    /*else*/ {
      __pyx_t_5 = __pyx_v_i;
      *((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_5 * __pyx_v_state.strides[0]) )) = -1;
    }
    __pyx_L5:;

    /* "bmtools/exact/helpers.pyx":87
 *         else:
 *             state[i] = -1
 *         index >>= 1             # <<<<<<<<<<<<<<
 */
...
/* Python wrapper */
static PyObject *__pyx_pw_7bmtools_5exact_7helpers_3index_to_state(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7bmtools_5exact_7helpers_2index_to_state[] = "index_to_state(long index, __Pyx_memviewslice state) -> void\nUpdate signed binary state vector to correspond to a state space index.\n\n    The encoding is big-endian, that is the most significant bit of the\n    integer index determines the first element of the binary state.\n\n    Args:\n        index (long): Integer state space enumeration index.\n        state (state_t[:]): Binary state vector to update.\n    ";
static PyObject *__pyx_pw_7bmtools_5exact_7helpers_3index_to_state(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  long __pyx_v_index;
  __Pyx_memviewslice __pyx_v_state = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("index_to_state (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_index,&__pyx_n_s_state,0};
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_state)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("index_to_state", 1, 2, 2, 1); __PYX_ERR(0, 71, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "index_to_state") < 0)) __PYX_ERR(0, 71, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_index = __Pyx_PyInt_As_long(values[0]); if (unlikely((__pyx_v_index == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L3_error)
    __pyx_v_state = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_7bmtools_5exact_7helpers_state_t(values[1]); if (unlikely(!__pyx_v_state.memview)) __PYX_ERR(0, 71, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("index_to_state", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 71, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("bmtools.exact.helpers.index_to_state", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7bmtools_5exact_7helpers_2index_to_state(__pyx_self, __pyx_v_index, __pyx_v_state);
...
static PyObject *__pyx_pf_7bmtools_5exact_7helpers_2index_to_state(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_index, __Pyx_memviewslice __pyx_v_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("index_to_state", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_7bmtools_5exact_7helpers_index_to_state(__pyx_v_index, __pyx_v_state, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "bmtools.exact.helpers.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.helpers.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.helpers.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.helpers._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"check_state_space_size", (PyCFunction)__pyx_pw_7bmtools_5exact_7helpers_1check_state_space_size, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7bmtools_5exact_7helpers_check_state_space_size},
  {"index_to_state", (PyCFunction)__pyx_pw_7bmtools_5exact_7helpers_3index_to_state, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7bmtools_5exact_7helpers_2index_to_state},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "helpers",
    __pyx_k_Boltzmann_machine_helpers_Cython, /* m_doc */
    -1, /* m_size */
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("helpers", __pyx_methods, __pyx_k_Boltzmann_machine_helpers_Cython, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_bmtools__exact__helpers) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bmtools.exact.helpers")) {
      if (unlikely(PyDict_SetItemString(modules, "bmtools.exact.helpers", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportVoidPtr(__pyx_n_s_state_t_code, (void *)&__pyx_v_7bmtools_5exact_7helpers_state_t_code, "char *") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Function export code ---*/
  if (__Pyx_ExportFunction("neg_energy", (void (*)(void))__pyx_f_7bmtools_5exact_7helpers_neg_energy, "double (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("check_state_space_size", (void (*)(void))__pyx_f_7bmtools_5exact_7helpers_check_state_space_size, "void (int, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("partition_state_space", (void (*)(void))__pyx_f_7bmtools_5exact_7helpers_partition_state_space, "__Pyx_memviewslice (long, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("index_to_state", (void (*)(void))__pyx_f_7bmtools_5exact_7helpers_index_to_state, "void (long, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("next_state", (void (*)(void))__pyx_f_7bmtools_5exact_7helpers_next_state, "void (__Pyx_memviewslice, long)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
 ...
 * 
 */
  __pyx_v_7bmtools_5exact_7helpers_state_t_code = ((char *)"c");

  /* "bmtools/exact/helpers.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bmtools.exact.helpers", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bmtools.exact.helpers");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
