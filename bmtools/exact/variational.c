...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "bmtools.exact.variational"
}
END: Cython Metadata */
...
#define __PYX_HAVE__bmtools__exact__variational
#define __PYX_HAVE_API__bmtools__exact__variational
#include "math.h"
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
static void __pyx_f_7bmtools_5exact_11variational_accum_kl_terms_for_state_range(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double *, double *, double *, long, long); /*proto*/
static void __pyx_f_7bmtools_5exact_11variational_accum_kl_and_grad_terms_for_state_range(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double *, double *, double *, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, long, long); /*proto*/
...
#define __Pyx_MODULE_NAME "bmtools.exact.variational"
int __pyx_module_is_main_bmtools__exact__variational = 0;

/* Implementation of 'bmtools.exact.variational' */
...
static const char __pyx_k_weights_1[] = "weights_1";
static const char __pyx_k_weights_2[] = "weights_2";
...
static const char __pyx_k_log_norm_const_2[] = "log_norm_const_2";
static const char __pyx_k_first_mom_1_terms[] = "first_mom_1_terms";
static const char __pyx_k_grads_wrt_biases_1[] = "grads_wrt_biases_1";
static const char __pyx_k_norm_const_1_terms[] = "norm_const_1_terms";
static const char __pyx_k_norm_const_2_terms[] = "norm_const_2_terms";
...
static PyObject *__pyx_n_s_first_mom_1_terms;
...
static PyObject *__pyx_n_s_kl_div_terms;
static PyObject *__pyx_n_s_kl_divergence;
static PyObject *__pyx_n_s_kl_divergence_and_gradients;
static PyObject *__pyx_n_s_log_norm_const_1;
static PyObject *__pyx_n_s_log_norm_const_2;
...
static PyObject *__pyx_n_s_norm_const_1_terms;
static PyObject *__pyx_n_s_norm_const_2_terms;
...
static PyObject *__pyx_n_s_second_mom_1_terms;
...
static PyObject *__pyx_pw_7bmtools_5exact_11variational_1kl_divergence(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_weights_1,&__pyx_n_s_biases_1,&__pyx_n_s_weights_2,&__pyx_n_s_biases_2,&__pyx_n_s_force,&__pyx_n_s_num_threads,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_weights_1)) != 0)) kw_args--;
...
static PyObject *__pyx_pf_7bmtools_5exact_11variational_kl_divergence(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_weights_1, __Pyx_memviewslice __pyx_v_biases_1, __Pyx_memviewslice __pyx_v_weights_2, __Pyx_memviewslice __pyx_v_biases_2, int __pyx_v_force, int __pyx_v_num_threads) {
  ...
  __Pyx_memviewslice __pyx_v_kl_div_terms = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_norm_const_1_terms = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_norm_const_2_terms = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_t;
  double __pyx_v_log_norm_const_1;
  double __pyx_v_log_norm_const_2;
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel num_threads(__pyx_v_num_threads) private(__pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19, __pyx_t_20) firstprivate(__pyx_t_15) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
                    ...
                    #endif /* _OPENMP */
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_t) lastprivate(__pyx_v_t) schedule(static, __pyx_t_11)
                    #endif /* _OPENMP */
 ...
 */
                            __pyx_t_15.data = __pyx_v_states.data;
                            __pyx_t_15.memview = __pyx_v_states.memview;
...
__pyx_t_15.shape[0] = __pyx_v_states.shape[1];
__pyx_t_15.strides[0] = __pyx_v_states.strides[1];
 ...
 *             states[t], &kl_div_terms[t],
 */
                            __pyx_f_7bmtools_5exact_11variational_accum_kl_terms_for_state_range(__pyx_v_weights_1, __pyx_v_biases_1, __pyx_v_weights_2, __pyx_v_biases_2, __pyx_t_15, (&(*((double *) ( /* dim=0 */ (__pyx_v_kl_div_terms.data + __pyx_t_16 * __pyx_v_kl_div_terms.strides[0]) )))), (&(*((double *) ( /* dim=0 */ (__pyx_v_norm_const_1_terms.data + __pyx_t_17 * __pyx_v_norm_const_1_terms.strides[0]) )))), (&(*((double *) ( /* dim=0 */ (__pyx_v_norm_const_2_terms.data + __pyx_t_18 * __pyx_v_norm_const_2_terms.strides[0]) )))), (*((long *) ( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_19 * __pyx_v_intervals.strides[0]) ))), (*((long *) ( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_20 * __pyx_v_intervals.strides[0]) ))));
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_kl_div_terms, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_norm_const_1_terms, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_norm_const_2_terms, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_weights_1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_biases_1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_weights_2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_biases_2, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_7bmtools_5exact_11variational_3kl_divergence_and_gradients(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7bmtools_5exact_11variational_2kl_divergence_and_gradients[] = "kl_divergence_and_gradients(__Pyx_memviewslice weights_1, __Pyx_memviewslice biases_1, __Pyx_memviewslice weights_2, __Pyx_memviewslice biases_2, bool force=False, int num_threads=4)\n\n    Calculates the KL divergence between two Boltzmann machine distributions\n    and its gradients with respect to the paramters of the first distribution.\n\n    Args:\n        weights_1 (double[:, :]): Weight parameters of first distribution.\n        biases_1 (double[:]): Bias parameters of first distribution.\n        weights_2 (double[:, :]): Weight parameters of second distritbution.\n        biases_2 (double[:]): Bias parameters of second distribution.\n        force (bool): Whether to force calculation for large state spaces.\n        num_threads (int): Number of parallel threads to use in calculation.\n\n    Returns:\n        kl_div (double): KL divergence between two distributions.\n        log_norm_const_1 (double): Logarithm of normalising constant for\n           first distribution (i.e. `log(Z_1)` in expression above).\n        log_norm_const_2 (double): Logarithm of normalising constant for\n           second distribution (i.e. `log(Z_2)` in expression above).\n        grads_wrt_biases_1 (double[:]): Gradients of KL divergence with\n            respect to bias parameters of first distribution.\n        grads_wrt_weights_1 (double[:, :]): Gradients of KL divergence with\n            respect to weight parameters of second distribution.\n        first_mom_1 (double[:]): First moments of first distribution.\n        second_mom_1 (double[:, :]): Second moments of first distribution.\n    ";
static PyMethodDef __pyx_mdef_7bmtools_5exact_11variational_3kl_divergence_and_gradients = {"kl_divergence_and_gradients", (PyCFunction)__pyx_pw_7bmtools_5exact_11variational_3kl_divergence_and_gradients, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7bmtools_5exact_11variational_2kl_divergence_and_gradients};
static PyObject *__pyx_pw_7bmtools_5exact_11variational_3kl_divergence_and_gradients(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_weights_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_biases_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_weights_2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_biases_2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("kl_divergence_and_gradients (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_weights_1,&__pyx_n_s_biases_1,&__pyx_n_s_weights_2,&__pyx_n_s_biases_2,&__pyx_n_s_force,&__pyx_n_s_num_threads,0};
    PyObject* values[6] = {0,0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
...
static PyObject *__pyx_pf_7bmtools_5exact_11variational_2kl_divergence_and_gradients(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_weights_1, __Pyx_memviewslice __pyx_v_biases_1, __Pyx_memviewslice __pyx_v_weights_2, __Pyx_memviewslice __pyx_v_biases_2, int __pyx_v_force, int __pyx_v_num_threads) {
  int __pyx_v_num_units;
  long __pyx_v_num_states;
  __Pyx_memviewslice __pyx_v_intervals = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_states = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_memviewslice __pyx_v_norm_const_1_terms = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_norm_const_2_terms = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_first_mom_1_terms = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_second_mom_1_terms = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_grads_wrt_biases_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_grads_wrt_weights_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_t;
  int __pyx_v_i;
  int __pyx_v_j;
  double __pyx_v_log_norm_const_1;
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel num_threads(__pyx_v_num_threads) private(__pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_19, __pyx_t_20, __pyx_t_21, __pyx_t_24, __pyx_t_25) firstprivate(__pyx_t_18, __pyx_t_22, __pyx_t_23, __pyx_t_7, __pyx_t_8) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
 ...
 *             intervals[t], intervals[t+1])
 */
                            __pyx_t_7.data = __pyx_v_first_mom_1_terms.data;
                            __pyx_t_7.memview = __pyx_v_first_mom_1_terms.memview;
                            __PYX_INC_MEMVIEW(&__pyx_t_7, 0);
                            {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_first_mom_1_terms.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_first_mom_1_terms.strides[0];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
            #ifdef WITH_THREAD
...
__pyx_t_7.shape[0] = __pyx_v_first_mom_1_terms.shape[1];
__pyx_t_7.strides[0] = __pyx_v_first_mom_1_terms.strides[1];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_t_8.data = __pyx_v_second_mom_1_terms.data;
                            __pyx_t_8.memview = __pyx_v_second_mom_1_terms.memview;
                            __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
                            {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_second_mom_1_terms.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_second_mom_1_terms.strides[0];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
            #ifdef WITH_THREAD
...
__pyx_t_8.shape[0] = __pyx_v_second_mom_1_terms.shape[1];
__pyx_t_8.strides[0] = __pyx_v_second_mom_1_terms.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__pyx_t_8.shape[1] = __pyx_v_second_mom_1_terms.shape[2];
__pyx_t_8.strides[1] = __pyx_v_second_mom_1_terms.strides[2];
 ...
 *     for t in range(1, num_threads):
 */
                            __pyx_t_22.memview = __pyx_v_grads_wrt_biases_1.memview;
                            __PYX_INC_MEMVIEW(&__pyx_t_22, 0);
                            {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_grads_wrt_biases_1.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_grads_wrt_biases_1.strides[0];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
            #ifdef WITH_THREAD
...
__pyx_t_22.shape[0] = __pyx_v_grads_wrt_biases_1.shape[1];
...
__pyx_t_23.data = __pyx_v_grads_wrt_weights_1.data;
                            __pyx_t_23.memview = __pyx_v_grads_wrt_weights_1.memview;
                            __PYX_INC_MEMVIEW(&__pyx_t_23, 0);
                            {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_grads_wrt_weights_1.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_grads_wrt_weights_1.strides[0];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
            #ifdef WITH_THREAD
...
__pyx_t_23.shape[0] = __pyx_v_grads_wrt_weights_1.shape[1];
__pyx_t_23.strides[0] = __pyx_v_grads_wrt_weights_1.strides[1];
    __pyx_t_23.suboffsets[0] = -1;

__pyx_t_23.shape[1] = __pyx_v_grads_wrt_weights_1.shape[2];
 ...
 *             states[t], &kl_div_terms[t],
 */
                            __pyx_f_7bmtools_5exact_11variational_accum_kl_and_grad_terms_for_state_range(__pyx_v_weights_1, __pyx_v_biases_1, __pyx_v_weights_2, __pyx_v_biases_2, __pyx_t_18, (&(*((double *) ( /* dim=0 */ (__pyx_v_kl_div_terms.data + __pyx_t_19 * __pyx_v_kl_div_terms.strides[0]) )))), (&(*((double *) ( /* dim=0 */ (__pyx_v_norm_const_1_terms.data + __pyx_t_20 * __pyx_v_norm_const_1_terms.strides[0]) )))), (&(*((double *) ( /* dim=0 */ (__pyx_v_norm_const_2_terms.data + __pyx_t_21 * __pyx_v_norm_const_2_terms.strides[0]) )))), __pyx_t_7, __pyx_t_8, __pyx_t_22, __pyx_t_23, (*((long *) ( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_24 * __pyx_v_intervals.strides[0]) ))), (*((long *) ( /* dim=0 */ (__pyx_v_intervals.data + __pyx_t_25 * __pyx_v_intervals.strides[0]) ))));
 ...
 *             for j in range(i):
 */
      __pyx_t_22.data = __pyx_v_first_mom_1_terms.data;
      __pyx_t_22.memview = __pyx_v_first_mom_1_terms.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_22, 0);
      {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_first_mom_1_terms.shape[0];
...
__pyx_t_22.shape[0] = __pyx_v_first_mom_1_terms.shape[1];
...
__pyx_t_33 = __pyx_v_i;
      *((double *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_33 * __pyx_t_7.strides[0]) )) += (*((double *) ( /* dim=0 */ (__pyx_t_22.data + __pyx_t_32 * __pyx_t_22.strides[0]) )));
      __PYX_XDEC_MEMVIEW(&__pyx_t_7, 1);
      __pyx_t_7.memview = NULL;
      __pyx_t_7.data = NULL;
...
__pyx_t_34 = __pyx_v_i;
      __pyx_t_7.data = __pyx_v_grads_wrt_biases_1.data;
      __pyx_t_7.memview = __pyx_v_grads_wrt_biases_1.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_7, 0);
      {
    Py_ssize_t __pyx_tmp_idx = 0;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_grads_wrt_biases_1.shape[0];
...
__pyx_t_7.shape[0] = __pyx_v_grads_wrt_biases_1.shape[1];
__pyx_t_7.strides[0] = __pyx_v_grads_wrt_biases_1.strides[1];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_t_35 = __pyx_v_i;
      *((double *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_35 * __pyx_t_7.strides[0]) )) += (*((double *) ( /* dim=0 */ (__pyx_t_22.data + __pyx_t_34 * __pyx_t_22.strides[0]) )));
      __PYX_XDEC_MEMVIEW(&__pyx_t_7, 1);
      __pyx_t_7.memview = NULL;
      __pyx_t_7.data = NULL;
      __PYX_XDEC_MEMVIEW(&__pyx_t_22, 1);
 ...
 */
        ...
        __pyx_t_23.memview = __pyx_v_second_mom_1_terms.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_23, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_second_mom_1_terms.shape[0];
...
__pyx_t_23.shape[0] = __pyx_v_second_mom_1_terms.shape[1];
__pyx_t_23.strides[0] = __pyx_v_second_mom_1_terms.strides[1];
    __pyx_t_23.suboffsets[0] = -1;

__pyx_t_23.shape[1] = __pyx_v_second_mom_1_terms.shape[2];
...
__pyx_t_40 = __pyx_v_i;
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_8.data + __pyx_t_40 * __pyx_t_8.strides[0]) ) + __pyx_t_41 * __pyx_t_8.strides[1]) )) += (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_23.data + __pyx_t_38 * __pyx_t_23.strides[0]) ) + __pyx_t_39 * __pyx_t_23.strides[1]) )));
...
__pyx_t_42 = __pyx_v_i;
        ...
        __pyx_t_8.data = __pyx_v_grads_wrt_weights_1.data;
        __pyx_t_8.memview = __pyx_v_grads_wrt_weights_1.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
        {
    Py_ssize_t __pyx_tmp_idx = 0;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_grads_wrt_weights_1.shape[0];
...
__pyx_t_8.shape[0] = __pyx_v_grads_wrt_weights_1.shape[1];
__pyx_t_8.strides[0] = __pyx_v_grads_wrt_weights_1.strides[1];
    __pyx_t_8.suboffsets[0] = -1;

__pyx_t_8.shape[1] = __pyx_v_grads_wrt_weights_1.shape[2];
__pyx_t_8.strides[1] = __pyx_v_grads_wrt_weights_1.strides[2];
    __pyx_t_8.suboffsets[1] = -1;

__pyx_t_44 = __pyx_v_i;
        __pyx_t_45 = __pyx_v_j;
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_8.data + __pyx_t_44 * __pyx_t_8.strides[0]) ) + __pyx_t_45 * __pyx_t_8.strides[1]) )) += (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_23.data + __pyx_t_42 * __pyx_t_23.strides[0]) ) + __pyx_t_43 * __pyx_t_23.strides[1]) )));
        __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
        __pyx_t_8.memview = NULL;
        __pyx_t_8.data = NULL;
        __PYX_XDEC_MEMVIEW(&__pyx_t_23, 1);
...
__pyx_t_54 = __pyx_v_i;
    *((double *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_54 * __pyx_t_7.strides[0]) )) -= ((*((double *) ( /* dim=0 */ (__pyx_v_kl_div_terms.data + __pyx_t_52 * __pyx_v_kl_div_terms.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_t_22.data + __pyx_t_53 * __pyx_t_22.strides[0]) ))));
    __PYX_XDEC_MEMVIEW(&__pyx_t_7, 1);
    __pyx_t_7.memview = NULL;
    __pyx_t_7.data = NULL;
    __PYX_XDEC_MEMVIEW(&__pyx_t_22, 1);
...
__pyx_t_64 = __pyx_v_j;
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_8.data + __pyx_t_64 * __pyx_t_8.strides[0]) ) + __pyx_t_65 * __pyx_t_8.strides[1]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_23.data + __pyx_t_62 * __pyx_t_23.strides[0]) ) + __pyx_t_63 * __pyx_t_23.strides[1]) )));
      __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
      __pyx_t_8.memview = NULL;
      __pyx_t_8.data = NULL;
      __PYX_XDEC_MEMVIEW(&__pyx_t_23, 1);
...
__pyx_t_72 = __pyx_v_i;
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_8.data + __pyx_t_72 * __pyx_t_8.strides[0]) ) + __pyx_t_73 * __pyx_t_8.strides[1]) )) -= ((*((double *) ( /* dim=0 */ (__pyx_v_kl_div_terms.data + __pyx_t_69 * __pyx_v_kl_div_terms.strides[0]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_23.data + __pyx_t_70 * __pyx_t_23.strides[0]) ) + __pyx_t_71 * __pyx_t_23.strides[1]) ))));
      __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
      __pyx_t_8.memview = NULL;
      __pyx_t_8.data = NULL;
      __PYX_XDEC_MEMVIEW(&__pyx_t_23, 1);
...
__pyx_t_76 = __pyx_v_j;
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_8.data + __pyx_t_76 * __pyx_t_8.strides[0]) ) + __pyx_t_77 * __pyx_t_8.strides[1]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_t_23.data + __pyx_t_74 * __pyx_t_23.strides[0]) ) + __pyx_t_75 * __pyx_t_23.strides[1]) )));
      __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
      __pyx_t_8.memview = NULL;
      __pyx_t_8.data = NULL;
      __PYX_XDEC_MEMVIEW(&__pyx_t_23, 1);
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_4);
  PyTuple_SET_ITEM(__pyx_t_84, 1, __pyx_t_4);
  __Pyx_GIVEREF(__pyx_t_3);
  PyTuple_SET_ITEM(__pyx_t_84, 2, __pyx_t_3);
  __Pyx_GIVEREF(__pyx_t_2);
  PyTuple_SET_ITEM(__pyx_t_84, 3, __pyx_t_2);
  __Pyx_GIVEREF(__pyx_t_9);
  PyTuple_SET_ITEM(__pyx_t_84, 4, __pyx_t_9);
  __Pyx_GIVEREF(__pyx_t_82);
  PyTuple_SET_ITEM(__pyx_t_84, 5, __pyx_t_82);
  __Pyx_GIVEREF(__pyx_t_83);
  PyTuple_SET_ITEM(__pyx_t_84, 6, __pyx_t_83);
  __pyx_t_5 = 0;
  __pyx_t_4 = 0;
  __pyx_t_3 = 0;
  __pyx_t_2 = 0;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_norm_const_1_terms, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_norm_const_2_terms, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_first_mom_1_terms, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_second_mom_1_terms, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_grads_wrt_biases_1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_grads_wrt_weights_1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_weights_1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_biases_1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_weights_2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_biases_2, 1);
...
static void __pyx_f_7bmtools_5exact_11variational_accum_kl_terms_for_state_range(__Pyx_memviewslice __pyx_v_weights_1, __Pyx_memviewslice __pyx_v_biases_1, __Pyx_memviewslice __pyx_v_weights_2, __Pyx_memviewslice __pyx_v_biases_2, __Pyx_memviewslice __pyx_v_state, double *__pyx_v_kl_div_term, double *__pyx_v_norm_const_1_term, double *__pyx_v_norm_const_2_term, long __pyx_v_start_state_index, long __pyx_v_end_state_index) {
  long __pyx_v_index_offset;
  double __pyx_v_neg_energy_1;
  double __pyx_v_neg_energy_2;
  double __pyx_v_unrm_prob_1;
  double __pyx_v_unrm_prob_2;
  long __pyx_t_1;
  long __pyx_t_2;
  long __pyx_t_3;
...
static void __pyx_f_7bmtools_5exact_11variational_accum_kl_and_grad_terms_for_state_range(__Pyx_memviewslice __pyx_v_weights_1, __Pyx_memviewslice __pyx_v_biases_1, __Pyx_memviewslice __pyx_v_weights_2, __Pyx_memviewslice __pyx_v_biases_2, __Pyx_memviewslice __pyx_v_state, double *__pyx_v_kl_div_term, double *__pyx_v_norm_const_1_term, double *__pyx_v_norm_const_2_term, __Pyx_memviewslice __pyx_v_first_mom_1, __Pyx_memviewslice __pyx_v_second_mom_1, __Pyx_memviewslice __pyx_v_grads_wrt_biases_1, __Pyx_memviewslice __pyx_v_grads_wrt_weights_1, long __pyx_v_start_state_index, long __pyx_v_end_state_index) {
  int __pyx_v_i;
  int __pyx_v_j;
  long __pyx_v_index_offset;
  double __pyx_v_neg_energy_1;
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grads_wrt_weights_1.data + __pyx_t_9 * __pyx_v_grads_wrt_weights_1.strides[0]) ) + __pyx_t_10 * __pyx_v_grads_wrt_weights_1.strides[1]) )) = 0.;
    }
  }
 ...
 *         neg_energy_2 = neg_energy(state, weights_2, biases_2)
 */
  __pyx_t_11 = (__pyx_v_end_state_index - __pyx_v_start_state_index);
  for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
    __pyx_v_index_offset = __pyx_t_12;
 ...
 */
    __pyx_t_13 = 0;
    (__pyx_v_norm_const_1_term[__pyx_t_13]) = ((__pyx_v_norm_const_1_term[__pyx_t_13]) + __pyx_v_unrm_prob_1);
 ...
 */
    __pyx_t_13 = 0;
    (__pyx_v_norm_const_2_term[__pyx_t_13]) = ((__pyx_v_norm_const_2_term[__pyx_t_13]) + __pyx_v_unrm_prob_2);
 ...
 */
    __pyx_t_13 = 0;
    (__pyx_v_kl_div_term[__pyx_t_13]) = ((__pyx_v_kl_div_term[__pyx_t_13]) + (__pyx_v_unrm_prob_1 * (__pyx_v_neg_energy_1 - __pyx_v_neg_energy_2)));
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_first_mom_1.data + __pyx_t_15 * __pyx_v_first_mom_1.strides[0]) )) += (__pyx_v_unrm_prob_1 * (*((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_14 * __pyx_v_state.strides[0]) ))));
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_grads_wrt_biases_1.data + __pyx_t_17 * __pyx_v_grads_wrt_biases_1.strides[0]) )) += ((__pyx_v_unrm_prob_1 * (__pyx_v_neg_energy_1 - __pyx_v_neg_energy_2)) * (*((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_16 * __pyx_v_state.strides[0]) ))));
 ...
 */
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_grads_wrt_weights_1.data + __pyx_t_24 * __pyx_v_grads_wrt_weights_1.strides[0]) ) + __pyx_t_25 * __pyx_v_grads_wrt_weights_1.strides[1]) )) += (((__pyx_v_unrm_prob_1 * (__pyx_v_neg_energy_1 - __pyx_v_neg_energy_2)) * (*((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_22 * __pyx_v_state.strides[0]) )))) * (*((__pyx_t_7bmtools_5exact_7helpers_state_t *) ( /* dim=0 */ (__pyx_v_state.data + __pyx_t_23 * __pyx_v_state.strides[0]) ))));
      }
    }

    /* "bmtools/exact/variational.pyx":260
 *                     state[i] * state[j]
 *                 )
 *         next_state(state, start_state_index + index_offset + 1)             # <<<<<<<<<<<<<<
 * 
...
/* "bmtools/exact/variational.pyx":263
 * 
 * 
...
static double __pyx_f_7bmtools_5exact_11variational_logistic_sigmoid(double __pyx_v_x) {
  ...
  /* "bmtools/exact/variational.pyx":265
 * cdef double logistic_sigmoid(double x) nogil:
 *     """Calculates the logistic sigmoid function."""
 *     return 1. / (1. + exp(-x))             # <<<<<<<<<<<<<<
 * 
...
/* "bmtools/exact/variational.pyx":268
 * 
 * 
...
static PyObject *__pyx_pw_7bmtools_5exact_11variational_5var_obj_and_grads_mean_field(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("var_obj_and_grads_mean_field (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_weights)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("var_obj_and_grads_mean_field", 1, 3, 3, 1); __PYX_ERR(0, 268, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_biases)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("var_obj_and_grads_mean_field", 1, 3, 3, 2); __PYX_ERR(0, 268, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "var_obj_and_grads_mean_field") < 0)) __PYX_ERR(0, 268, __pyx_L3_error)
      }
    ...
    __pyx_v_var_biases = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0]); if (unlikely(!__pyx_v_var_biases.memview)) __PYX_ERR(0, 269, __pyx_L3_error)
    __pyx_v_weights = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_weights.memview)) __PYX_ERR(0, 269, __pyx_L3_error)
    __pyx_v_biases = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2]); if (unlikely(!__pyx_v_biases.memview)) __PYX_ERR(0, 269, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("var_obj_and_grads_mean_field", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 268, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_7bmtools_5exact_11variational_4var_obj_and_grads_mean_field(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_var_biases, __Pyx_memviewslice __pyx_v_weights, __Pyx_memviewslice __pyx_v_biases) {
  ...
  /* "bmtools/exact/variational.pyx":300
 *         var_first_mom (double[:]): First moments of variational distribution.
 *     """
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_num_units); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 303, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_t_2);
  __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_shape, __pyx_t_3) < 0) __PYX_ERR(0, 303, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 303, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_itemsize, __pyx_t_3) < 0) __PYX_ERR(0, 303, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_format, __pyx_n_s_d) < 0) __PYX_ERR(0, 303, __pyx_L1_error)
 ...
 *     cdef double[:] grads_wrt_var_biases = array(
 */
  __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 302, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_3);
  if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 302, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_num_units); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 305, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_shape, __pyx_t_2) < 0) __PYX_ERR(0, 305, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 305, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_itemsize, __pyx_t_2) < 0) __PYX_ERR(0, 305, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     cdef double var_obj = 0.
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_array_type), __pyx_empty_tuple, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 304, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_2);
  if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 304, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_grads_wrt_var_biases = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "bmtools/exact/variational.pyx":306
 *     cdef double[:] grads_wrt_var_biases = array(
 *         shape=(num_units,), itemsize=sizeof(double), format='d')
 *     cdef double var_obj = 0.             # <<<<<<<<<<<<<<
 *     cdef double prob_p_i, prob_m_i
 ...
 */
    ...
    /* "bmtools/exact/variational.pyx":318
 *         var_obj += (
 *             0.5 * var_first_mom[i] * grads_wrt_var_biases[i] -
 *             var_first_mom[i] * biases[i]             # <<<<<<<<<<<<<<
 *             + prob_p_i * log(prob_p_i) + prob_m_i * log(prob_m_i)
 ...
 */
  ...
  /* "bmtools/exact/variational.pyx":323
 *         grads_wrt_var_biases[i] += var_biases[i] - biases[i]
 *         grads_wrt_var_biases[i] *= 4. * prob_p_i * prob_m_i
 *     return var_obj, grads_wrt_var_biases, var_first_mom             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_var_obj); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 323, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_grads_wrt_var_biases, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 323, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_var_first_mom, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 323, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_25 = PyTuple_New(3); if (unlikely(!__pyx_t_25)) __PYX_ERR(0, 323, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "bmtools.exact.variational.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.variational.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.variational.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "bmtools.exact.variational._memoryviewslice", /*tp_name*/
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "variational",
    __pyx_k_Boltzmann_machine_variational_in, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_first_mom_1_terms, __pyx_k_first_mom_1_terms, sizeof(__pyx_k_first_mom_1_terms), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_kl_div_terms, __pyx_k_kl_div_terms, sizeof(__pyx_k_kl_div_terms), 0, 0, 1, 1},
  {&__pyx_n_s_kl_divergence, __pyx_k_kl_divergence, sizeof(__pyx_k_kl_divergence), 0, 0, 1, 1},
  {&__pyx_n_s_kl_divergence_and_gradients, __pyx_k_kl_divergence_and_gradients, sizeof(__pyx_k_kl_divergence_and_gradients), 0, 0, 1, 1},
  {&__pyx_n_s_log_norm_const_1, __pyx_k_log_norm_const_1, sizeof(__pyx_k_log_norm_const_1), 0, 0, 1, 1},
  {&__pyx_n_s_log_norm_const_2, __pyx_k_log_norm_const_2, sizeof(__pyx_k_log_norm_const_2), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_norm_const_1_terms, __pyx_k_norm_const_1_terms, sizeof(__pyx_k_norm_const_1_terms), 0, 0, 1, 1},
  {&__pyx_n_s_norm_const_2_terms, __pyx_k_norm_const_2_terms, sizeof(__pyx_k_norm_const_2_terms), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_second_mom_1_terms, __pyx_k_second_mom_1_terms, sizeof(__pyx_k_second_mom_1_terms), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initvariational(void); /*proto*/
PyMODINIT_FUNC initvariational(void)
#else
PyMODINIT_FUNC PyInit_variational(void); /*proto*/
PyMODINIT_FUNC PyInit_variational(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_variational(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("variational", __pyx_methods, __pyx_k_Boltzmann_machine_variational_in, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_bmtools__exact__variational) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bmtools.exact.variational")) {
      if (unlikely(PyDict_SetItemString(modules, "bmtools.exact.variational", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     """Calculate mean-field variational objective and gradients.
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_7bmtools_5exact_11variational_5var_obj_and_grads_mean_field, NULL, __pyx_n_s_bmtools_exact_variational); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 268, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_var_obj_and_grads_mean_field, __pyx_t_3) < 0) __PYX_ERR(0, 268, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init bmtools.exact.variational", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init bmtools.exact.variational");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
